...
Supports config from YAML files, command line, and parameter dictionaries.
Priority: command line > parameter dictionaries > config file
"""
import os
import re
import yaml
...
class Config:
    """
    Configurator that loads parameters from multiple sources.
    """
